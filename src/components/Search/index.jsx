...
const Search = () => {
  ...
  placeholder="поиск пиццы">Поиск пиццы...</input>
  {searchValue && (
  <svg onClick={() => setSearchValue('')} className={styles.clearIcon} viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"><defs><style>.cls-1</style></defs><title/><g id="cross"><line x1="7" x2="25" y1="7" y2="25"/><line x1="7" x2="25" y1="25" y2="7"/></g></svg>
  )}
  </div>
}
